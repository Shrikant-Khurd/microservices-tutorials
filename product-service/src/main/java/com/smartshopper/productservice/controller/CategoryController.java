package com.smartshopper.productservice.controller;
...
import com.smartshopper.productservice.exception.RecordNotFoundException;
import com.smartshopper.productservice.model.SubCategory;
import com.smartshopper.productservice.service.CategoryService;
...
public class CategoryController {
	...
	public ResponseEntity<ApiResponse> deleteMainCategory(@PathVariable long id) {
		ApiResponse response = categoryService.deleteMainCategoryById(id);
		return new ResponseEntity<>(response, response.getHttpStatus());
	}
