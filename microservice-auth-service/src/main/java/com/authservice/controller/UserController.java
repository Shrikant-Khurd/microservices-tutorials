...
//	}
	...
	/*
	 * @GetMapping("address-detail-id/{addressId}") public
	 * ResponseEntity<AddressDto>
	 * getAddressDetailByAddress(@PathVariable("addressId") long addressId) {
	 * AddressDto getAddressDetails =
	 * userService.getAddressDetailByAddress(addressId); return new
	 * ResponseEntity<>(getAddressDetails, HttpStatus.OK); }
	 * 
	 * @GetMapping("get-all-user-address/{userId}") public
	 * ResponseEntity<ApiResponse> getAddressesByUserId(@PathVariable("userId") long
	 * userId) { ApiResponse userAddresses =
	 * userService.getAddressesByUserId(userId); return new
	 * ResponseEntity<>(userAddresses, HttpStatus.OK); }
	 * 
	 * @PostMapping("user-id/{userId}/update-address/{addressId}") public
	 * ResponseEntity<ApiResponse> updateUserAddress(@PathVariable("userId") long
	 * userId,
	 * 
	 * @RequestBody AddressDto updatedAddressDto, @PathVariable("addressId") long
	 * addressId) { ApiResponse addAddress = userService.updateUserAddress(userId,
	 * updatedAddressDto, addressId); return new ResponseEntity<>(addAddress,
	 * addAddress.getHttpStatus()); }
	 * 
	 * @PostMapping("user-id/{userId}/delete-address/{addressId}") public
	 * ResponseEntity<ApiResponse> deleteAddress(@PathVariable("userId") long
	 * userId,
	 * 
	 * @PathVariable("addressId") long addressId) { ApiResponse deleteAddress =
	 * userService.deleteAddress(userId, addressId); return new
	 * ResponseEntity<>(deleteAddress, deleteAddress.getHttpStatus()); }
	 */
