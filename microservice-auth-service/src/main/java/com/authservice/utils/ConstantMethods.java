...
public class ConstantMethods {
	...
	public static boolean isEmail(String email) {
		// Implement logic to check if the input is a valid email
		// Example: You can use regex or other validation methods
		return email != null && email.matches("\\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2,}\\b");
//		 String emailRegex = "^[A-Za-z0-9+_.-]+@(.+)$";
//		    return email.matches(emailRegex);
	}

	public static boolean isContactNumber(String contactNumber) {
		// Implement logic to check if the input is a valid contact number
		// Example: You can use regex or other validation methods
